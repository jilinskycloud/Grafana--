...
/* harmony import */ var _explore__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./explore */ "./public/app/core/utils/explore.ts");
/* harmony import */ var _features_explore_state_selectors__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../features/explore/state/selectors */ "./public/app/features/explore/state/selectors.ts");
/* harmony import */ var _grafana_data_src_utils_url__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @grafana/data/src/utils/url */ "./packages/grafana-data/src/utils/url.ts");
...
var sortQueries = function sortQueries(array, sortOrder) {
  ...
  if (sortOrder === _explore__WEBPACK_IMPORTED_MODULE_4__["SortOrder"].Ascending) {
    sortFunc = function sortFunc(a, b) {
      return a.ts < b.ts ? -1 : a.ts > b.ts ? 1 : 0;
    };
  }

  if (sortOrder === _explore__WEBPACK_IMPORTED_MODULE_4__["SortOrder"].Descending) {
    sortFunc = function sortFunc(a, b) {
      return a.ts < b.ts ? 1 : a.ts > b.ts ? -1 : 0;
    };
  }

  if (sortOrder === _explore__WEBPACK_IMPORTED_MODULE_4__["SortOrder"].DatasourceZA) {
    sortFunc = function sortFunc(a, b) {
      return a.datasourceName < b.datasourceName ? -1 : a.datasourceName > b.datasourceName ? 1 : 0;
    };
  }

  if (sortOrder === _explore__WEBPACK_IMPORTED_MODULE_4__["SortOrder"].DatasourceAZ) {
    sortFunc = function sortFunc(a, b) {
      return a.datasourceName < b.datasourceName ? 1 : a.datasourceName > b.datasourceName ? -1 : 0;
    };
  }
...
var createUrlFromRichHistory = function createUrlFromRichHistory(query) {
  ...
  var serializedState = Object(_grafana_data_src_utils_url__WEBPACK_IMPORTED_MODULE_6__["serializeStateToUrlParam"])(exploreState, true);
...
function createQueryHeading(query, sortOrder) {
  ...
  if (sortOrder === _explore__WEBPACK_IMPORTED_MODULE_4__["SortOrder"].DatasourceAZ || sortOrder === _explore__WEBPACK_IMPORTED_MODULE_4__["SortOrder"].DatasourceZA) {
...
function createDatasourcesList(queriesDatasources) {
  var exploreDatasources = Object(_features_explore_state_selectors__WEBPACK_IMPORTED_MODULE_5__["getExploreDatasources"])();
  var datasources = [];
...
/* harmony import */ var _grafana_data_src_utils_url__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @grafana/data/src/utils/url */ "./packages/grafana-data/src/utils/url.ts");
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _nonIterableSpread(); }
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                exploreDatasources = Object(_selectors__WEBPACK_IMPORTED_MODULE_15__["getExploreDatasources"])();
...
var stateSave = function stateSave() {
  return function (dispatch, getState) {
    ...
    urlStates.left = Object(_grafana_data_src_utils_url__WEBPACK_IMPORTED_MODULE_16__["serializeStateToUrlParam"])(leftUrlState, true);
    ...
    if (split) {
      ...
      urlStates.right = Object(_grafana_data_src_utils_url__WEBPACK_IMPORTED_MODULE_16__["serializeStateToUrlParam"])(rightUrlState, true);
    }
...
var updateTime = function updateTime(config) {
  return function (dispatch, getState) {
    ...
    Object(_dashboard_services_TimeSrv__WEBPACK_IMPORTED_MODULE_13__["getTimeSrv"])().init({
      ...
      timeRangeUpdated: function timeRangeUpdated() {
        return undefined;
      }
    });
...
//# sourceMappingURL=default~DashboardPage~SoloPanelPage~explore.aae40212254ed8359ce4.js.map