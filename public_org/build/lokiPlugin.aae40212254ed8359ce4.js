...
/* harmony import */ var _LokiExploreExtraField__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./LokiExploreExtraField */ "./public/app/plugins/datasource/loki/components/LokiExploreExtraField.tsx");
...
function LokiExploreQueryEditor(props) {
  ...
  if (data && !lodash__WEBPACK_IMPORTED_MODULE_1___default.a.isEmpty(data.request)) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_LokiQueryField__WEBPACK_IMPORTED_MODULE_2__["LokiQueryField"], {
    ...
    ExtraFieldElement: react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_LokiExploreExtraField__WEBPACK_IMPORTED_MODULE_3__["default"], {
      label: 'Line limit',
...
function (_PureComponent) {
  ...
  function LokiQueryEditor(props) {
    ...
    _this.calcAbsoluteRange = function (data) {
  ...
  _createClass(LokiQueryEditor, [{
    ...
    value: function render() {
      ...
      }, "Legend"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
        type: "text",
...
var LokiQueryField = function LokiQueryField(props) {
  var datasource = props.datasource,
      ...
      otherProps = _objectWithoutProperties(props, ["datasource", "absoluteRange"]);

  var _useLokiSyntaxAndLabe = Object(_useLokiSyntaxAndLabels__WEBPACK_IMPORTED_MODULE_2__["useLokiSyntaxAndLabels"])(datasource.languageProvider, absoluteRange),
...
var DerivedFields = function DerivedFields(props) {
  ...
  }, "Derived fields"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: styles.infoText
  }, "Derived fields can be used to extract new fields from the log message and create link from it's value."), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: "gf-form-group"
  ...
  }, "Add"), value && value.length > 0 && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_2__["Button"], {
    variant: "secondary",
    onClick: function onClick() {
      return setShowDebug(!showDebug);
    }
  }, showDebug ? 'Hide example log message' : 'Show example log message'))), showDebug && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: "gf-form-group"
...
/* harmony import */ var _live_streams__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./live_streams */ "./public/app/plugins/datasource/loki/live_streams.ts");
/* harmony import */ var _language_provider__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./language_provider */ "./public/app/plugins/datasource/loki/language_provider.ts");
/* harmony import */ var _core_utils_fetch__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../../core/utils/fetch */ "./public/app/core/utils/fetch.ts");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_DataSourceApi) {
  ...
  function LokiDatasource(instanceSettings, templateSrv) {
    ...
    _this.streams = new _live_streams__WEBPACK_IMPORTED_MODULE_10__["LiveStreams"]();
    ...
    _this.runInstantQuery = function (target, options, responseListLength) {
      ...
      return _this._request(INSTANT_QUERY_ENDPOINT, query).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (err) {
        return _this.throwUnless(err, err.cancelled, target);
      }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["filter"])(function (response) {
    ...
    _this.runRangeQuery = function (target, options) {
      ...
      return _this._request(RANGE_QUERY_ENDPOINT, query).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (err) {
        return _this.throwUnless(err, err.cancelled || err.status === 404, target);
      }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["filter"])(function (response) {
        return response.cancelled ? false : true;
      }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])(function (response) {
        return Object(_result_transformer__WEBPACK_IMPORTED_MODULE_7__["processRangeQueryResponse"])(response.data, target, query, responseListLength, linesLimit, _this.instanceSettings.jsonData, options.reverse);
      }));
    };
      ...
      if (err.data) {
        if (typeof err.data === 'string') {
          if (err.data.includes('escape') && target.expr.includes('\\')) {
            error.message = "Error: ".concat(err.data, ". Make sure that all special characters are escaped with \\. For more information on escaping of special characters visit LogQL documentation at https://github.com/grafana/loki/blob/master/docs/logql.md.");
          } else {
    ...
    _this.languageProvider = new _language_provider__WEBPACK_IMPORTED_MODULE_11__["default"](_assertThisInitialized(_this));
  ...
  _createClass(LokiDatasource, [{
    ...
    value: function _request(apiUrl, data, options) {
      ...
      var params = data ? Object(_core_utils_fetch__WEBPACK_IMPORTED_MODULE_12__["serializeParams"])(data) : '';
      ...
      return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["from"])(Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_4__["getBackendSrv"])().datasourceRequest(req));
    }
  }, {
    key: "query",
    value: function query(options) {
      ...
      filteredTargets.forEach(function (target) {
        return subQueries.push(_this2.runRangeQuery(target, options, filteredTargets.length));
    ...
    value: function createLiveTarget(target, options) {
      var query = target.expr;
      var baseUrl = this.instanceSettings.url;
      var params = Object(_core_utils_fetch__WEBPACK_IMPORTED_MODULE_12__["serializeParams"])({
        query: query
      });
      return {
        query: query,
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                ...
                _context3.next = 5;
                return this.processMetricFindQuery(interpolated);
    ...
    value: function () {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 7:
                ...
                _context4.next = 11;
                return this.labelValuesQuery(labelValues[2]);
      ...
      function processMetricFindQuery(_x6) {
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                _context5.next = 3;
                return this.metadataRequest(url);
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee6(label) {
        var url, result;
    ...
    value: function () {
      ...
      regeneratorRuntime.mark(function _callee7(options) {
        var interpolatedExpr, query, _ref, data, annotations, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _loop, _iterator, _step;
...
function addHistoryMetadata(item, history) {
  ...
  var hint = "Queried ".concat(historyForItem.length, " times in the last 24h.");
      ...
      regeneratorRuntime.mark(function _callee3(input, context) {
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                wrapperClasses = input.wrapperClasses, value = input.value, prefix = input.prefix, text = input.text; // Local text properties
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 15:
                ...
                _context4.next = 20;
                return this.getLabelValues(labelKey);
        ...
        return regeneratorRuntime.wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                _context11.next = 2;
                return this.fetchLabelValues(key, this.initialRange);
...
/*!******************************************************************!*\
  !*** ./public/app/plugins/datasource/loki/result_transformer.ts ***!
  \******************************************************************/
/*! exports provided: lokiStreamResultToDataFrame, appendResponseToBufferedData, lokiResultsToTableModel, decamelize, lokiStreamsToDataframes, enhanceDataFrame, rangeQueryResponseToTimeSeries, processRangeQueryResponse */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function createMetricLabel(labelData, options) {
  var label = options === undefined || lodash__WEBPACK_IMPORTED_MODULE_0___default.a.isEmpty(options.legendFormat) ? getOriginalMetricName(labelData) : renderTemplate(app_features_templating_template_srv__WEBPACK_IMPORTED_MODULE_4__["default"].replace(options.legendFormat), labelData);
...
function processRangeQueryResponse(response, target, query, responseListLength, limit, config) {
...
//# sourceMappingURL=lokiPlugin.aae40212254ed8359ce4.js.map