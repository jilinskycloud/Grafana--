  ...
  _createClass(CloudMonitoringMetricFindQuery, [{
    ...
    value: function () {
      ...
      regeneratorRuntime.mark(function _callee8(_ref6) {
        ...
        var selectedMetricType, projectName, metricDescriptors, _metricDescriptors$fi, valueType, metricKind;
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 5:
                ...
                _metricDescriptors$fi = metricDescriptors.find(function (m) {
                  return m.type === _this.datasource.templateSrv.replace(selectedMetricType);
                }), valueType = _metricDescriptors$fi.valueType, metricKind = _metricDescriptors$fi.metricKind;
                return _context8.abrupt("return", Object(_functions__WEBPACK_IMPORTED_MODULE_3__["getAlignmentOptionsByMetric"])(valueType, metricKind).map(this.toFindQueryResult));
    ...
    value: function () {
      ...
      regeneratorRuntime.mark(function _callee9(_ref7) {
        ...
        var selectedMetricType, projectName, metricDescriptors, _metricDescriptors$fi2, valueType, metricKind;
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 5:
                ...
                _metricDescriptors$fi2 = metricDescriptors.find(function (m) {
                  return m.type === _this2.datasource.templateSrv.replace(selectedMetricType);
                }), valueType = _metricDescriptors$fi2.valueType, metricKind = _metricDescriptors$fi2.metricKind;
                return _context9.abrupt("return", Object(_functions__WEBPACK_IMPORTED_MODULE_3__["getAggregationOptionsByMetric"])(valueType, metricKind).map(this.toFindQueryResult));
  ...
  _createClass(CloudMonitoringVariableQueryEditor, [{
    ...
    value: function render() {
      ...
      if (this.state.loading) {
        ...
        }, "Query Type"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: "gf-form-select-wrapper max-width-12"
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("select", {
          className: "gf-form-input"
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("option", null, "Loading..."))));
      }
...
function (_DataSourceApi) {
  ...
  _createClass(CloudMonitoringDatasource, [{
            ...
            switch (_context4.prev = _context4.next) {
              ...
              case 2:
                queries = options.targets.map(this.migrateQuery).filter(this.shouldRunQuery).map(function (q) {
                  return _this3.prepareTimeSeriesQuery(q, options);
                });
    ...
    value: function shouldRunQuery(query) {
      ...
      if (query.queryType && query.queryType === _types__WEBPACK_IMPORTED_MODULE_2__["QueryType"].SLO) {
    ...
    value: function prepareTimeSeriesQuery(_ref10, _ref11) {
      var metricQuery = _ref10.metricQuery,
          refId = _ref10.refId,
          queryType = _ref10.queryType,
          sloQuery = _ref10.sloQuery;
      var scopedVars = _ref11.scopedVars,
          intervalMs = _ref11.intervalMs;
      return {
        datasourceId: this.id,
        refId: refId,
        queryType: queryType,
    ...
    value: function interpolateFilters(filters, scopedVars) {
      ...
      var completeFilter = lodash__WEBPACK_IMPORTED_MODULE_0___default.a.chunk(filters, 4).map(function (_ref12) {
      ...
      var filterArray = lodash__WEBPACK_IMPORTED_MODULE_0___default.a.flatten(completeFilter.map(function (_ref14) {
        var key = _ref14.key,
            operator = _ref14.operator,
            value = _ref14.value,
            condition = _ref14.condition;
        return [_this5.templateSrv.replace(key, scopedVars || {}), operator, _this5.templateSrv.replace(value, scopedVars || {}, 'regex')].concat(_toConsumableArray(condition ? [condition] : []));
      }));
    ...
    value: function interpolateGroupBys(groupBys, scopedVars) {
      ...
      (groupBys || []).forEach(function (gb) {
        var interpolated = _this6.templateSrv.replace(gb, scopedVars || {}, 'csv').split(',');
...
//# sourceMappingURL=cloudMonitoringPlugin.aae40212254ed8359ce4.js.map