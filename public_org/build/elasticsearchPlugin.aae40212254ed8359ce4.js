...
var DataLinks = function DataLinks(props) {
  ...
  }, "Data links"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: styles.infoText
  }, "Add links to existing fields. Links will be shown in log row details next to the field value."), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
...
var ElasticDetails = function ElasticDetails(props) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", {
    className: "page-heading"
  }, "Elasticsearch details"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: "gf-form-group"
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    inputEl: react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Input, {
      ...
      placeholder: "10s",
      validationEvents: _defineProperty({}, _grafana_ui__WEBPACK_IMPORTED_MODULE_1__["EventsWithValidation"].onBlur, [Object(_grafana_ui__WEBPACK_IMPORTED_MODULE_1__["regexValidation"])(/^\d+(ms|[Mwdhmsy])$/, 'Value is not valid, you can use number with time unit specifier: y, M, w, d, h, m, s')])
    }),
    tooltip: react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, "A lower limit for the auto group by time interval. Recommended to be set to write frequency, for example ", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("code", null, "1m"), " if your data is written every minute.")
  })))));
};
...
var LogsConfig = function LogsConfig(props) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", {
    className: "page-heading"
  }, "Logs"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: "gf-form-group"
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: "gf-form max-width-30"
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(FormField, {
...
/* harmony import */ var _elastic_response__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./elastic_response */ "./public/app/plugins/datasource/elasticsearch/elastic_response.ts");
...
/* harmony import */ var _query_builder__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./query_builder */ "./public/app/plugins/datasource/elasticsearch/query_builder.ts");
...
function (_DataSourceApi) {
  ...
  function ElasticDatasource(instanceSettings, templateSrv, timeSrv) {
    ...
    _this.indexPattern = new _index_pattern__WEBPACK_IMPORTED_MODULE_4__["IndexPattern"](_this.index, settingsData.interval);
    _this.interval = settingsData.timeInterval;
    _this.maxConcurrentShardRequests = settingsData.maxConcurrentShardRequests;
    _this.queryBuilder = new _query_builder__WEBPACK_IMPORTED_MODULE_5__["ElasticQueryBuilder"]({
  ...
  _createClass(ElasticDatasource, [{
    ...
    value: function request(method, url, data) {
      ...
      return Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_7__["getBackendSrv"])().datasourceRequest(options).catch(function (err) {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee(indexList, url) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 10:
                ...
                if (!(_context.t0.status !== 404 || i === maxTraversals - 1)) {
                  _context.next = 14;
                  break;
                }
      ...
      function requestAllIndices(_x, _x2) {
    ...
    value: function query(options) {
      ...
      try {
        for (var _iterator = targets[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          if (target.isLogsQuery || _query_def__WEBPACK_IMPORTED_MODULE_6__["hasMetricOfType"](target, 'logs')) {
            target.bucketAggs = [_query_def__WEBPACK_IMPORTED_MODULE_6__["defaultBucketAgg"]()];
      ...
      return this.post(url, payload).then(function (res) {
        var er = new _elastic_response__WEBPACK_IMPORTED_MODULE_3__["ElasticResponse"](sentTargets, res);
...
function () {
    ...
    this.processResponseToSeries = function () {
      ...
      for (var i = 0; i < _this.response.responses.length; i++) {
        ...
        if (_response.hits && _response.hits.hits.length > 0) {
          _this.processHits(_response.hits, seriesList);
        }
  ...
  _createClass(ElasticResponse, [{
    ...
    key: "processHits",
    value: function processHits(hits, seriesList) {
    ...
    value: function processResponseToDataFrames(isLogsRequest, logMessageField, logLevelField) {
      ...
      for (var n = 0; n < this.response.responses.length; n++) {
        ...
        if (_response2.aggregations) {
          ...
          if (table.rows.length > 0) {
            dataFrame.push(Object(_grafana_data__WEBPACK_IMPORTED_MODULE_4__["toDataFrame"])(table));
          }

          for (var y = 0; y < tmpSeriesList.length; y++) {
            var _series = Object(_grafana_data__WEBPACK_IMPORTED_MODULE_4__["toDataFrame"])(tmpSeriesList[y]); // When log results, show aggregations only in graph. Log fields are then going to be shown in table.


            if (isLogsRequest) {
              _series = addPreferredVisualisationType(_series, 'graph');
            }
...
var flattenHits = function flattenHits(hits) {
  ...
  try {
    for (var _iterator7 = hits[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
      ...
      var flattened = hit._source ? Object(app_core_utils_flatten__WEBPACK_IMPORTED_MODULE_1__["default"])(hit._source, null) : {};
...
//# sourceMappingURL=elasticsearchPlugin.aae40212254ed8359ce4.js.map