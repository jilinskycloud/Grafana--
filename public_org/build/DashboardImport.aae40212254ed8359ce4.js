...
function (_PureComponent) {
        ...
        var readerOnLoad = function readerOnLoad() {
          return function (e) {
            ...
            try {
              ...
              app_core_app_events__WEBPACK_IMPORTED_MODULE_9__["default"].emit(_grafana_data__WEBPACK_IMPORTED_MODULE_2__["AppEvents"].alertError, ['Import failed', 'JSON -> JS Serialization failed: ' + error.message]);
              return;
            }
  ...
  _createClass(DashboardImportUnConnected, [{
    ...
    value: function renderImportForm() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      ...
      }, "Upload JSON file")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: styles.option
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Legend"], null, "Import via grafana.com"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Form"], {
        ...
        className: styles.option
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Legend"], null, "Import via panel json"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Form"], {
...
var ImportDashboardForm = function ImportDashboardForm(_ref) {
  ...
  */
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_1__["Legend"], null, "Options"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_1__["Field"], {
    label: "Name",
    ...
    description: "The unique identifier (uid) of a dashboard can be used for uniquely identify a dashboard between multiple Grafana installs. The uid allows having consistent URL\u2019s for accessing dashboards so changing the title of a dashboard will not break any bookmarked links to that dashboard.",
    invalid: !!errors.uid,
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_1__["Field"], {
      label: input.label,
      error: errors.constants && errors.constants[index] && "".concat(input.label, " needs a value"),
...
function (_PureComponent) {
  ...
  function ImportDashboardOverviewUnConnected() {
    ...
    _this.onSubmit = function (form) {
      _this.props.saveDashboard(form);
    };
  ...
  _createClass(ImportDashboardOverviewUnConnected, [{
    ...
    value: function render() {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_2__["Legend"], null, "Importing Dashboard from", ' ', react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
...
var mapDispatchToProps = {
  ...
  saveDashboard: _state_actions__WEBPACK_IMPORTED_MODULE_5__["saveDashboard"]
};
...
/*!****************************************************************!*\
  !*** ./public/app/features/manage-dashboards/state/actions.ts ***!
  \****************************************************************/
/*! exports provided: fetchGcomDashboard, importDashboardJson, clearLoadedDashboard, saveDashboard */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fetchGcomDashboard", function() { return fetchGcomDashboard; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "importDashboardJson", function() { return importDashboardJson; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "clearLoadedDashboard", function() { return clearLoadedDashboard; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "saveDashboard", function() { return saveDashboard; });
...
/* harmony import */ var _reducers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./reducers */ "./public/app/features/manage-dashboards/state/reducers.ts");
...
/* harmony import */ var _core_core__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../core/core */ "./public/app/core/core.ts");
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_1__["getBackendSrv"])().get("/api/gnet/dashboards/".concat(id));

              case 3:
                dashboard = _context.sent;
                dispatch(Object(_reducers__WEBPACK_IMPORTED_MODULE_3__["setGcomDashboard"])(dashboard));
              ...
              case 8:
                ...
                _core_core__WEBPACK_IMPORTED_MODULE_5__["appEvents"].emit(_grafana_data__WEBPACK_IMPORTED_MODULE_0__["AppEvents"].alertError, [_context.t0.data.message || _context.t0]);
      ...
      regeneratorRuntime.mark(function _callee2(dispatch) {
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                dispatch(Object(_reducers__WEBPACK_IMPORTED_MODULE_3__["setJsonDashboard"])(dashboard));
  ...
  return function (dispatch) {
    if (dashboardJson && dashboardJson.__inputs) {
      ...
      dashboardJson.__inputs.forEach(function (input) {
        ...
        if (input.type === _reducers__WEBPACK_IMPORTED_MODULE_3__["InputType"].DataSource) {
      ...
      dispatch(Object(_reducers__WEBPACK_IMPORTED_MODULE_3__["setInputs"])(inputs));
    }
  };
}
...
function clearLoadedDashboard() {
  return function (dispatch) {
    dispatch(Object(_reducers__WEBPACK_IMPORTED_MODULE_3__["clearDashboard"])());
  };
}
function saveDashboard(importDashboardForm) {
  return (
    /*#__PURE__*/
    function () {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                inputsToPersist = [];
                (_importDashboardForm$ = importDashboardForm.dataSources) === null || _importDashboardForm$ === void 0 ? void 0 : _importDashboardForm$.forEach(function (dataSource, index) {
                ...
                (_importDashboardForm$2 = importDashboardForm.constants) === null || _importDashboardForm$2 === void 0 ? void 0 : _importDashboardForm$2.forEach(function (constant, index) {
                ...
                _context3.next = 7;
                return Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_1__["getBackendSrv"])().post('api/dashboards/import', {
                  dashboard: _objectSpread({}, dashboard, {
                    title: importDashboardForm.title,
                    uid: importDashboardForm.uid
                  }),
                  overwrite: true,
              ...
              case 7:
                ...
                dashboardUrl = _grafana_data__WEBPACK_IMPORTED_MODULE_0__["locationUtil"].stripBaseFromUrl(result.importedUrl);
                dispatch(Object(app_core_actions__WEBPACK_IMPORTED_MODULE_4__["updateLocation"])({
                  path: dashboardUrl
                }));
...
var getDataSourceOptions = function getDataSourceOptions(input, inputModel) {
  var sources = Object.values(app_core_config__WEBPACK_IMPORTED_MODULE_2__["default"].datasources).filter(function (val) {
...
var validateUid = function validateUid(value) {
  return Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_1__["getBackendSrv"])().get("/api/dashboards/uid/".concat(value)).then(function (existingDashboard) {
    return "Dashboard named '".concat(existingDashboard === null || existingDashboard === void 0 ? void 0 : existingDashboard.dashboard.title, "' in folder '").concat(existingDashboard === null || existingDashboard === void 0 ? void 0 : existingDashboard.meta.folderTitle, "' has the same uid");
  }).catch(function (error) {
...
//# sourceMappingURL=DashboardImport.aae40212254ed8359ce4.js.map