...
function withFormatting(text, edit, formattingOptions) {
  ...
  var edits = Object(_format_js__WEBPACK_IMPORTED_MODULE_0__["format"])(newText, {
    offset: begin,
    length: end - begin
...
function stripComments(text, replaceCh) {
  var _scanner = Object(_scanner_js__WEBPACK_IMPORTED_MODULE_0__["createScanner"])(text),
      parts = [],
      kind,
      offset = 0,
      pos;
...
function getLanguageService(params) {
  ...
  return {
    ...
    parseJSONDocument: function parseJSONDocument(document) {
      return Object(_parser_jsonParser_js__WEBPACK_IMPORTED_MODULE_4__["parse"])(document, {
        collectComments: true
      });
    },
    newJSONDocument: function newJSONDocument(root, diagnostics) {
      return Object(_parser_jsonParser_js__WEBPACK_IMPORTED_MODULE_4__["newJSONDocument"])(root, diagnostics);
    },
...
function parse(textDocument, config) {
  ...
  function _errorAtRange(message, code, startOffset, endOffset, severity) {
    if (severity === void 0) {
      severity = _jsonLanguageTypes_js__WEBPACK_IMPORTED_MODULE_2__["DiagnosticSeverity"].Error;
    }
  ...
  function _parseArray(parent) {
    ...
    /* EOF */
      ...
      if (!item) {
        _error(localize('PropertyExpected', 'Value expected'), _jsonLanguageTypes_js__WEBPACK_IMPORTED_MODULE_2__["ErrorCode"].ValueExpected, null, [], [4
        /* CloseBracketToken */
        , 5
        /* CommaToken */
        ]);
  ...
  function _parseProperty(parent, keysSeen) {
    ...
    if (!value) {
      return _error(localize('ValueExpected', 'Value expected'), _jsonLanguageTypes_js__WEBPACK_IMPORTED_MODULE_2__["ErrorCode"].ValueExpected, node, [], [2
      /* CloseBraceToken */
      , 5
      /* CommaToken */
      ]);
  ...
  function _parseObject(parent) {
    ...
    /* EOF */
      ...
      if (!property) {
        _error(localize('PropertyExpected', 'Property expected'), _jsonLanguageTypes_js__WEBPACK_IMPORTED_MODULE_2__["ErrorCode"].PropertyExpected, null, [], [2
        /* CloseBraceToken */
        , 5
        /* CommaToken */
        ]);
...
function () {
  ...
  JSONCompletion.prototype.getSuggestionKind = function (type) {
    ...
    switch (type) {
      ...
      case 'object':
        return _jsonLanguageTypes_js__WEBPACK_IMPORTED_MODULE_5__["CompletionItemKind"].Module;

      case 'property':
        return _jsonLanguageTypes_js__WEBPACK_IMPORTED_MODULE_5__["CompletionItemKind"].Property;
...
function () {
          ...
          if (item.type === 'object') {
            for (var _b = 0, _c = item.properties; _b < _c.length; _b++) {
              ...
              if (property.keyNode.value === 'key' && property.valueNode) {
                ...
                result_1.push({
                  name: _parser_jsonParser_js__WEBPACK_IMPORTED_MODULE_0__["getNodeValue"](property.valueNode),
                  kind: _jsonLanguageTypes_js__WEBPACK_IMPORTED_MODULE_3__["SymbolKind"].Function,
                  location: location
                });
                limit--;
  ...
  JSONDocumentSymbols.prototype.getColorPresentations = function (document, doc, color, range) {
    ...
    result.push({
      label: label,
      textEdit: _jsonLanguageTypes_js__WEBPACK_IMPORTED_MODULE_3__["TextEdit"].replace(range, JSON.stringify(label))
    });
    return result;
  };
          ...
          && startLine + 1 < document.lineCount) {
            ...
            if (startLine < endLine) {
              addRange({
                startLine: startLine,
                endLine: endLine,
                kind: _jsonLanguageTypes_js__WEBPACK_IMPORTED_MODULE_1__["FoldingRangeKind"].Comment
              });
              prevStart = startLine;
            }
          }
          ...
          if (m) {
            ...
            if (m[1]) {
              ...
              var range = {
                startLine: line,
                endLine: line,
                kind: _jsonLanguageTypes_js__WEBPACK_IMPORTED_MODULE_1__["FoldingRangeKind"].Region
              };
              stack.push(range);
            } else {
...
function schemaAllowsTrailingCommas(schemaRef) {
  if (schemaRef && _typeof(schemaRef) === 'object') {
    ...
    if (Object(_utils_objects_js__WEBPACK_IMPORTED_MODULE_3__["isBoolean"])(schemaRef['allowsTrailingCommas'])) {
      // deprecated
...
function toDiagnosticSeverity(severityLevel) {
  switch (severityLevel) {
    case 'error':
      return _jsonLanguageTypes_js__WEBPACK_IMPORTED_MODULE_1__["DiagnosticSeverity"].Error;

    case 'warning':
      return _jsonLanguageTypes_js__WEBPACK_IMPORTED_MODULE_1__["DiagnosticSeverity"].Warning;
...
function toSeverity(lsSeverity) {
  switch (lsSeverity) {
    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["DiagnosticSeverity"].Error:
      return monaco.MarkerSeverity.Error;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["DiagnosticSeverity"].Warning:
      return monaco.MarkerSeverity.Warning;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["DiagnosticSeverity"].Information:
      return monaco.MarkerSeverity.Info;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["DiagnosticSeverity"].Hint:
...
function toCompletionItemKind(kind) {
  ...
  switch (kind) {
    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Text:
      return mItemKind.Text;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Method:
      return mItemKind.Method;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Function:
      return mItemKind.Function;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Constructor:
      return mItemKind.Constructor;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Field:
      return mItemKind.Field;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Variable:
      return mItemKind.Variable;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Class:
      return mItemKind.Class;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Interface:
      return mItemKind.Interface;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Module:
      return mItemKind.Module;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Property:
      return mItemKind.Property;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Unit:
      return mItemKind.Unit;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Value:
      return mItemKind.Value;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Enum:
      return mItemKind.Enum;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Keyword:
      return mItemKind.Keyword;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Snippet:
      return mItemKind.Snippet;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Color:
      return mItemKind.Color;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].File:
      return mItemKind.File;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Reference:
...
function fromCompletionItemKind(kind) {
  ...
  switch (kind) {
    case mItemKind.Text:
      return _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Text;

    case mItemKind.Method:
      return _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Method;

    case mItemKind.Function:
      return _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Function;

    case mItemKind.Constructor:
      return _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Constructor;

    case mItemKind.Field:
      return _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Field;

    case mItemKind.Variable:
      return _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Variable;

    case mItemKind.Class:
      return _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Class;

    case mItemKind.Interface:
      return _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Interface;

    case mItemKind.Module:
      return _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Module;
    ...
    case mItemKind.Unit:
      return _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Unit;

    case mItemKind.Value:
      return _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Value;

    case mItemKind.Enum:
      return _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Enum;

    case mItemKind.Keyword:
      return _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Keyword;

    case mItemKind.Snippet:
      return _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Snippet;

    case mItemKind.Color:
      return _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Color;

    case mItemKind.File:
      return _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].File;

    case mItemKind.Reference:
      return _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["CompletionItemKind"].Reference;
  }
...
function toSymbolKind(kind) {
  ...
  switch (kind) {
    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["SymbolKind"].File:
      return mKind.Array;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["SymbolKind"].Module:
      return mKind.Module;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["SymbolKind"].Namespace:
      return mKind.Namespace;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["SymbolKind"].Package:
      return mKind.Package;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["SymbolKind"].Class:
      return mKind.Class;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["SymbolKind"].Method:
      return mKind.Method;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["SymbolKind"].Property:
      return mKind.Property;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["SymbolKind"].Field:
      return mKind.Field;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["SymbolKind"].Constructor:
      return mKind.Constructor;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["SymbolKind"].Enum:
      return mKind.Enum;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["SymbolKind"].Interface:
      return mKind.Interface;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["SymbolKind"].Function:
      return mKind.Function;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["SymbolKind"].Variable:
      return mKind.Variable;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["SymbolKind"].Constant:
      return mKind.Constant;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["SymbolKind"].String:
      return mKind.String;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["SymbolKind"].Number:
      return mKind.Number;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["SymbolKind"].Boolean:
      return mKind.Boolean;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["SymbolKind"].Array:
      return mKind.Array;
  }
...
function toFoldingRangeKind(kind) {
  switch (kind) {
    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["FoldingRangeKind"].Comment:
      return monaco.languages.FoldingRangeKind.Comment;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["FoldingRangeKind"].Imports:
      return monaco.languages.FoldingRangeKind.Imports;

    case _deps_vscode_json_languageservice_jsonLanguageService_js__WEBPACK_IMPORTED_MODULE_0__["FoldingRangeKind"].Region:
...
//# sourceMappingURL=1.aae40212254ed8359ce4.js.map