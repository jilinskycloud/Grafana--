...
function (_PureComponent) {
  ...
  _createClass(PluginHelp, [{
    ...
    value: function render() {
      ...
      if (isLoading) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", null, "Loading help...");
      }

      if (isError) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", null, "'Error occurred when loading help'");
      }
...
/* harmony import */ var _getAlertingValidationMessage__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./getAlertingValidationMessage */ "./public/app/features/alerting/getAlertingValidationMessage.ts");
...
/* harmony import */ var _StateHistory__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./StateHistory */ "./public/app/features/alerting/StateHistory.tsx");
/* harmony import */ var app_features_alerting_AlertTabCtrl__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! app/features/alerting/AlertTabCtrl */ "./public/app/features/alerting/AlertTabCtrl.ts");
/* harmony import */ var _TestRuleResult__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./TestRuleResult */ "./public/app/features/alerting/TestRuleResult.tsx");
/* harmony import */ var app_types__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! app/types */ "./public/app/types/index.ts");
...
/* harmony import */ var _dashboard_components_PanelEditor_types__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../dashboard/components/PanelEditor/types */ "./public/app/features/dashboard/components/PanelEditor/types.ts");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_PureComponent) {
  ...
  function UnConnectedAlertTab() {
    ...
    _this.switchToQueryTab = function () {
      var updateLocation = _this.props.updateLocation;
      updateLocation({
        query: {
          tab: _dashboard_components_PanelEditor_types__WEBPACK_IMPORTED_MODULE_13__["PanelEditorTabId"].Query
        },
        partial: true
      });
    };
    ...
    _this.renderValidationMessage = function () {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", null, validatonMessage), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("br", null), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "gf-form-group"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Button"], {
        size: 'md',
        variant: 'secondary',
        icon: "arrow-left",
        onClick: _this.switchToQueryTab
      }, "Go back to Queries")));
    };
    ...
    _this.renderTestRule = function () {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Modal"], {
        isOpen: true,
        icon: "bug",
        title: "Testing rule",
        onDismiss: onDismiss,
        onClickBackdrop: onDismiss
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_TestRuleResult__WEBPACK_IMPORTED_MODULE_10__["TestRuleResult"], {
        panel: panel,
        dashboard: dashboard
      }));
    };
    ...
    _this.renderDeleteConfirmation = function () {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["ConfirmModal"], {
        isOpen: true,
        icon: "trash-alt",
        title: "Delete",
        body: react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, "Are you sure you want to delete this alert rule?", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("br", null), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("small", null, "You need to save dashboard for the delete to take effect.")),
    ...
    _this.renderStateHistory = function () {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Modal"], {
        ...
        onDismiss: onDismiss,
        onClickBackdrop: onDismiss
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_StateHistory__WEBPACK_IMPORTED_MODULE_8__["default"], {
        dashboard: dashboard,
  ...
  _createClass(UnConnectedAlertTab, [{
    ...
    value: function () {
      ...
      regeneratorRuntime.mark(function _callee() {
        ...
        var _this$props3, panel, angularPanelComponent, scope, loader, template, scopeProps, validatonMessage;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 7:
                ...
                loader = Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_5__["getAngularLoader"])();
                template = '<alert-tab />';
                scopeProps = {
                  ctrl: this.panelCtrl
                };
                ...
                _context.next = 14;
                return Object(_getAlertingValidationMessage__WEBPACK_IMPORTED_MODULE_6__["getAlertingValidationMessage"])(panel.transformations, panel.targets, Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_5__["getDataSourceSrv"])(), panel.datasource);

              case 14:
                validatonMessage = _context.sent;
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["CustomScrollbar"], {
        autoHeightMin: "100%"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Container"], {
        padding: "md"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        "aria-label": _grafana_e2e_selectors__WEBPACK_IMPORTED_MODULE_4__["selectors"].components.AlertTab.content
      }, alert && hasTransformations && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Alert"], {
        severity: app_types__WEBPACK_IMPORTED_MODULE_11__["AppNotificationSeverity"].Error,
        title: "Transformations are not supported in alert queries"
      }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ref: function ref(element) {
          return _this3.element = element;
        }
      }), alert && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["HorizontalGroup"], null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Button"], {
        onClick: function onClick() {
          return _this3.onToggleModal('showStateHistory');
        },
        variant: "secondary"
      }, "State history"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Button"], {
        onClick: function onClick() {
          return _this3.onToggleModal('showTestRule');
        },
        variant: "secondary"
      }, "Test rule"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Button"], {
        onClick: function onClick() {
          return _this3.onToggleModal('showDeleteConfirmation');
        },
        variant: "destructive"
      }, "Delete")), !alert && !validatonMessage && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(app_core_components_EmptyListCTA_EmptyListCTA__WEBPACK_IMPORTED_MODULE_7__["default"], model)))), this.renderTestRule(), this.renderDeleteConfirmation(), this.renderStateHistory());
    }
  }]);
  ...
  _createClass(StateHistory, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, stateHistoryItems.length > 0 && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        className: "muted"
      }, "Last 50 state changes"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_2__["ConfirmButton"], {
        ...
        variant: "destructive",
        icon: "trash-alt"
      }, "Clear history"))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ol", {
      ...
      }) : react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", null, "No state changes recorded")));
    }
  }]);
...
function (_PureComponent) {
  ...
  function TestRuleResult() {
    ...
    _this.onClipboardSuccess = function () {
      app_core_app_events__WEBPACK_IMPORTED_MODULE_2__["default"].emit(_grafana_data__WEBPACK_IMPORTED_MODULE_5__["AppEvents"].alertSuccess, ['Content copied to clipboard']);
    };
  ...
  _createClass(TestRuleResult, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        name: "copy"
      }), " Copy to Clipboard")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_1__["JSONFormatter"], {
...
var AddPanelWidgetCreate = function AddPanelWidgetCreate(_ref3) {
  ...
  }, "Add new panel"), copiedPanelPlugins.length === 1 && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_2__["Button"], {
    variant: "secondary",
    size: "md",
    onClick: function onClick() {
...
function (_PureComponent) {
  ...
  function InspectDataTab(props) {
    ...
    _this.exportCsv = function (dataFrame) {
      var panel = _this.props.panel;
      var transformId = _this.state.transformId; // Replace the time field with a formatted time

      var _getTimeField = Object(_grafana_data__WEBPACK_IMPORTED_MODULE_1__["getTimeField"])(dataFrame),
          timeIndex = _getTimeField.timeIndex,
          timeField = _getTimeField.timeField;

      if (timeField) {
        // Use the configurd date or standandard time display
        var processor = timeField.display;

        if (!processor) {
          processor = Object(_grafana_data__WEBPACK_IMPORTED_MODULE_1__["getDisplayProcessor"])({
            field: timeField
          });
        }

        var formattedDateField = _objectSpread({}, timeField, {
          type: _grafana_data__WEBPACK_IMPORTED_MODULE_1__["FieldType"].string,
          values: new _grafana_data__WEBPACK_IMPORTED_MODULE_1__["FormattedVector"](timeField.values, processor)
        });

        var fields = _toConsumableArray(dataFrame.fields);

        fields[timeIndex] = formattedDateField;
        dataFrame = _objectSpread({}, dataFrame, {
          fields: fields
        });
      }
    ...
    _this.getActiveString = function () {
      var selectedDataFrame = _this.state.selectedDataFrame;
      var _this$props = _this.props,
      ...
      if (selectedDataFrame === _grafana_data__WEBPACK_IMPORTED_MODULE_1__["DataTransformerID"].seriesToColumns) {
        ...
        activeString = Object(_grafana_data__WEBPACK_IMPORTED_MODULE_1__["getFrameDisplayName"])(data[selectedDataFrame]);
      }
    ...
    _this.renderDataOptions = function (dataFrames) {
      var _panel$plugin;
      ...
      var _this$state = _this.state,
          ...
          selectedDataFrame = _this$state.selectedDataFrame;
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(app_core_components_QueryOperationRow_QueryOperationRow__WEBPACK_IMPORTED_MODULE_9__["QueryOperationRow"], {
        ...
        headerElement: react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_DetailText__WEBPACK_IMPORTED_MODULE_10__["DetailText"], null, _this.getActiveString()),
        isOpen: false
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        onChange: _this.onDataFrameChange,
        width: 30
    ...
    _this.state = {
      selectedDataFrame: _grafana_data__WEBPACK_IMPORTED_MODULE_1__["DataTransformerID"].seriesToColumns,
      dataFrameIndex: 0,
      transformId: _grafana_data__WEBPACK_IMPORTED_MODULE_1__["DataTransformerID"].seriesToColumns,
  ...
  _createClass(InspectDataTab, [{
    ...
    value: function render() {
      ...
      if (!dataFrames[dataFrameIndex]) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, "Could not find the Data Frame");
      }
      ...
      }, "Download CSV")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_2__["Container"], {
        grow: 1
...
function (_PureComponent) {
  ...
  function InspectJSONTab(props) {
    ...
    _this.getJSONObject = function (show) {
      ...
      return {
        note: "Unknown Object: ".concat(show)
      };
    };
    ...
    _this.onApplyPanelModel = function () {
      ...
      try {
        if (!dashboard.meta.canEdit) {
          app_core_core__WEBPACK_IMPORTED_MODULE_6__["appEvents"].emit(_grafana_data__WEBPACK_IMPORTED_MODULE_2__["AppEvents"].alertError, ['Unable to apply']);
        } else {
          var updates = JSON.parse(_this.state.text);
          panel.restoreModel(updates);
          panel.refresh();
          app_core_core__WEBPACK_IMPORTED_MODULE_6__["appEvents"].emit(_grafana_data__WEBPACK_IMPORTED_MODULE_2__["AppEvents"].alertSuccess, ['Panel model updated']);
        }
      } catch (err) {
        console.log('Error applyign updates', err);
        app_core_core__WEBPACK_IMPORTED_MODULE_6__["appEvents"].emit(_grafana_data__WEBPACK_IMPORTED_MODULE_2__["AppEvents"].alertError, ['Invalid JSON text']);
      }
...
/* harmony import */ var _grafana_runtime__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @grafana/runtime */ "./packages/grafana-runtime/src/index.ts");
/* harmony import */ var emotion__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! emotion */ "./node_modules/emotion/dist/emotion.esm.js");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_PureComponent) {
  ...
  _createClass(QueryInspector, [{
    ...
    value: function renderExecutedQueries(executedQueries) {
      ...
      var styles = {
        refId: Object(emotion__WEBPACK_IMPORTED_MODULE_10__["css"])(_templateObject(), _grafana_runtime__WEBPACK_IMPORTED_MODULE_9__["config"].theme.typography.weight.semibold, _grafana_runtime__WEBPACK_IMPORTED_MODULE_9__["config"].theme.colors.textBlue)
      };
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, executedQueries.map(function (info) {
        ...
        }, info.refId, ":"), info.frames > 1 && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, info.frames, " frames, "), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, info.rows, " rows")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("pre", null, info.query));
      }));
    }
  }, {
    key: "render",
    value: function render() {
      ...
      }, "Query inspector allows you to view raw request and response. To collect this data Grafana needs to issue a new query. Hit refresh button below to trigger a new query.")), this.renderExecutedQueries(executedQueries), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: styles.toolbar
...
var OverrideFieldConfigEditor = function OverrideFieldConfigEditor(props) {
  ...
  var onOverrideChange = function onOverrideChange(index, override) {
    var config = props.config;
    var overrides = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_1___default()(config.overrides);
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    title: "Overrides",
    featureState: _grafana_data__WEBPACK_IMPORTED_MODULE_2__["FeatureState"].beta // url={getDocsLink(DocsId.FieldConfigOverrides)}
    ,
    className: Object(emotion__WEBPACK_IMPORTED_MODULE_9__["css"])(_templateObject(), theme.spacing.md)
  }, "Field options overrides give you a fine grained control over how your data is displayed."), renderOverrides(), renderAddOverride());
};
var DefaultFieldConfigEditor = function DefaultFieldConfigEditor(_ref) {
  var data = _ref.data,
      ...
      config = _ref.config,
      plugin = _ref.plugin;
  var setDefaultValue = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(function (name, value, custom) {
    ...
    if (custom) {
      if (defaults.custom) {
        if (remove) {
          defaults.custom = _objectSpread({}, defaults.custom);
          delete defaults.custom[name];
        } else {
          defaults.custom = _objectSpread({}, defaults.custom, _defineProperty({}, name, value));
        }
      } else if (!remove) {
        defaults.custom = _defineProperty({}, name, value);
      }
    } else if (remove) {
  ...
  var renderEditor = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(function (item, categoryItemCount) {
    ...
    var value = item.isCustom ? defaults.custom ? defaults.custom[item.path] : undefined : defaults[item.path];
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Field"], {
      ...
      onChange: function onChange(v) {
        return setDefaultValue(item.path, v, item.isCustom);
      },
      context: {
        data: data,
...
var getStyles = Object(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["stylesFactory"])(function (theme, isExpanded, isNested) {
  return {
    ...
    toggle: Object(emotion__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject3(), theme.colors.textWeak, theme.typography.size.lg, theme.spacing.sm),
    header: Object(emotion__WEBPACK_IMPORTED_MODULE_1__["cx"])(Object(emotion__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject4(), theme.spacing.sm, theme.spacing.md, theme.spacing.sm, theme.spacing.sm, isExpanded ? theme.colors.text : theme.colors.formLabel, theme.typography.weight.semibold, theme.colors.text, theme.colors.text), isNested && Object(emotion__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject5())),
    body: Object(emotion__WEBPACK_IMPORTED_MODULE_1__["cx"])(Object(emotion__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject6(), theme.spacing.md, theme.spacing.md, theme.spacing.xl), isNested && Object(emotion__WEBPACK_IMPORTED_MODULE_1__["css"])(_templateObject7(), theme.colors.pageHeaderBorder))
  };
});
...
var OverrideEditor = function OverrideEditor(_ref) {
  ...
  var styles = getStyles(theme);
  var matcherLabel = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_2__["Label"], {
    category: ['Matcher'],
    description: matcherUi.description
  }, matcherUi.name);
  ...
  var renderOverrideTitle = function renderOverrideTitle(isExpanded) {
    ...
    }, "Matcher ", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_2__["Icon"], {
      name: "angle-right"
    }), " ", matcherUi.name, " ", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("br", null), override.properties.length === 0 ? 'No' : override.properties.length, " properties overriden"));
  };
  ...
  })), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, override.properties.map(function (p, j) {
    var item = registry.getIfExists(p.id);

    if (!item) {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, "Unknown property: ", p.id);
    }
...
function (_PureComponent) {
  ...
  _createClass(PanelEditorUnconnected, [{
    ...
    value: function editorToolbar(styles) {
      ...
      }, dashboard.title, " / Edit Panel"))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_1__["HorizontalGroup"], null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_1__["HorizontalGroup"], {
        spacing: "sm",
        align: "center"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_1__["Button"], {
        icon: "cog",
      ...
      }, "Discard"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_1__["Button"], {
        onClick: this.onSaveDashboard,
        variant: "secondary",
        title: "Apply changes and save dashboard"
      }, "Save"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_1__["Button"], {
        onClick: this.onPanelExit,
...
var PanelOptionsTab = function PanelOptionsTab(_ref) {
  var panel = _ref.panel,
      ...
      onPanelConfigChange = _ref.onPanelConfigChange,
      onPanelOptionsChanged = _ref.onPanelOptionsChanged;
  var visTabInputRef = Object(react__WEBPACK_IMPORTED_MODULE_0__["useRef"])();
  ...
  elements.push(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_OptionsGroup__WEBPACK_IMPORTED_MODULE_6__["OptionsGroup"], {
    ...
    label: "Transparent",
    description: "Display panel without a background."
  ...
  elements.push(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_OptionsGroup__WEBPACK_IMPORTED_MODULE_6__["OptionsGroup"], {
    renderTitle: function renderTitle(isExpanded) {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, "Links ", !isExpanded && panelLinksCount > 0 && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_1__["Counter"], {
    ...
    onChange: function onChange(links) {
      return onPanelConfigChange('links', links);
    },
...
var usePanelLatestData = function usePanelLatestData(panel, options) {
  var querySubscription = Object(react__WEBPACK_IMPORTED_MODULE_1__["useRef"])(null);
...
var RowOptionsForm = function RowOptionsForm(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_1__["Form"], {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_1__["Field"], {
      ...
      type: "submit"
    }, "Update"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_1__["Button"], {
      variant: "secondary",
      onClick: onCancel
    }, "Cancel")));
  });
...
function (_PureComponent) {
  ...
  function DashboardLinksDashboard() {
    ...
    _this.renderElement = function (linkElement, key) {
    ...
    _this.renderList = function () {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, resolvedLinks.length > 0 && resolvedLinks.map(function (resolvedLink, index) {
        ...
        return _this.renderElement(linkElement, "dashlinks-list-item-".concat(resolvedLink.id, "-").concat(index));
      }));
    };
    ...
    _this.renderDropdown = function () {
      ...
      return _this.renderElement(linkElement, 'dashlinks-dropdown');
    };
...
var TransformationEditor = function TransformationEditor(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
  ...
  }, "Transformation input data"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    className: styles.debugTitle
  }, "Transformation output data"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: styles.debugJson
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_2__["JSONFormatter"], {
    json: output
  })))));
...
var TransformationOperationRow = function TransformationOperationRow(_ref) {
  var children = _ref.children,
      onRemove = _ref.onRemove,
      props = _objectWithoutProperties(_ref, ["children", "onRemove"]);
...
function (_React$PureComponent) {
  ...
  function TransformationsEditor(props) {
    ...
    _this.renderTransformationEditors = function () {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, transformations.map(function (t, i) {
        var editor;
        var transformationUI = _grafana_data__WEBPACK_IMPORTED_MODULE_2__["standardTransformersRegistry"].getIfExists(t.id);

        if (!transformationUI) {
          return null;
        }

        var input = Object(_grafana_data__WEBPACK_IMPORTED_MODULE_2__["transformDataFrame"])(transformations.slice(0, i), data);
        var output = Object(_grafana_data__WEBPACK_IMPORTED_MODULE_2__["transformDataFrame"])(transformations.slice(i), input);

        if (transformationUI) {
          editor = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(transformationUI.editor, {
            options: _objectSpread({}, transformationUI.transformation.defaultOptions, {}, t.options),
            input: input,
  ...
  _createClass(TransformationsEditor, [{
    ...
    value: function renderNoAddedTransformsState() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_1__["VerticalGroup"], {
        ...
        featureState: _grafana_data__WEBPACK_IMPORTED_MODULE_2__["FeatureState"].beta // url={getDocsLink(DocsId.Transformations)}

      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, "Transformations allow you to join, calculate, re-order, hide and rename your query results before being visualized. ", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("br", null), "Many transforms are not suitable if you're using the Graph visualization as it currently only supports time series. ", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("br", null), "It can help to switch to Table visualization to understand what a transformation is doing. ", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("br", null)), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, "Select one of the transformations below to start."))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_1__["VerticalGroup"], null, _grafana_data__WEBPACK_IMPORTED_MODULE_2__["standardTransformersRegistry"].list().map(function (t) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(TransformationCard, {
          key: t.name,
          title: t.name,
          description: t.description,
          actions: react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_1__["Button"], null, "Select"),
    ...
    value: function render() {
      ...
      }, !hasTransforms && this.renderNoAddedTransformsState(), hasTransforms && this.renderTransformationEditors(), hasTransforms && this.renderTransformationSelector())));
    }
  }]);
...
function (_PureComponent) {
  ...
  _createClass(DashboardPage, [{
      ...
      if (!editPanel && urlEditPanelId) {
        this.getPanelByIdFromUrlParam(urlEditPanelId, function (panel) {
          ...
          if (!dashboard.canEditPanel(panel)) {
            _this2.props.notifyApp(Object(app_core_copy_appNotification__WEBPACK_IMPORTED_MODULE_4__["createErrorNotification"])('Permission to edit panel denied'));
    ...
    value: function getPanelByIdFromUrlParam(urlPanelId, callback) {
      ...
      if (!panel) {
        // Panel not found
        this.props.notifyApp(Object(app_core_copy_appNotification__WEBPACK_IMPORTED_MODULE_4__["createErrorNotification"])("Panel with id ".concat(urlPanelId, " not found"))); // Clear url state
    ...
    value: function triggerPanelsRendering() {
      try {
        ...
        console.error(err);
        this.props.notifyApp(Object(app_core_copy_appNotification__WEBPACK_IMPORTED_MODULE_4__["createErrorNotification"])("Panel rendering error", err));
      }
    }
  }, {
...
function (_PureComponent) {
  ...
  _createClass(QueriesTab, [{
    ...
    value: function renderAddQueryRow() {
      ...
      }, "Query"), isAddingMixed && this.renderMixedPicker(), app_core_config__WEBPACK_IMPORTED_MODULE_8__["default"].featureToggles.expressions && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Button"], {
        icon: "plus",
...
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _QueryEditorRow__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./QueryEditorRow */ "./public/app/features/dashboard/panel_editor/QueryEditorRow.tsx");
...
function (_PureComponent) {
  ...
  function QueryEditorRows() {
    ...
    _this.onAddQuery = function (query) {
      ...
      onChangeQueries(Object(app_core_utils_query__WEBPACK_IMPORTED_MODULE_3__["addQuery"])(queries, query));
    ...
    _this.onMoveQuery = function (query, direction) {
      ...
      var index = lodash__WEBPACK_IMPORTED_MODULE_1___default.a.indexOf(queries, query); // @ts-ignore


      lodash__WEBPACK_IMPORTED_MODULE_1___default.a.move(queries, index, index + direction);
  ...
  _createClass(QueryEditorRows, [{
    ...
    value: function render() {
      ...
      return props.queries.map(function (query, index) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_QueryEditorRow__WEBPACK_IMPORTED_MODULE_2__["QueryEditorRow"], {
          ...
          onMoveQuery: _this2.onMoveQuery,
  ...
  _createClass(QueryOptions, [{
    ...
    value: function renderMaxDataPointsOption() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        width: 9,
        tooltip: react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, "The maximum data points per series. Used directly by some data sources and used in calculation of auto interval. With streaming data this value is used for the rolling buffer.")
      }, "Max data points"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Input, {
        type: "number",
        className: "width-6",
    ...
    value: function renderIntervalOption() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        width: 9,
        tooltip: react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, "A lower limit for the interval. Recommended to be set to write frequency, for example ", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("code", null, "1m"), ' ', "if your data is written every minute. Default value can be set in data source settings for most data sources.")
      }, "Min interval"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Input, {
        type: "text",
        className: "width-6",
        ...
        width: 9,
        tooltip: react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, "The evaluated Interval that is sent to data source and is used in ", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("code", null, "$__interval"), " and", ' ', react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("code", null, "$__interval_ms"))
      }, "Interval"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_2__["InlineFormLabel"], {
        width: 6
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(app_core_components_QueryOperationRow_QueryOperationRow__WEBPACK_IMPORTED_MODULE_3__["QueryOperationRow"], {
        ...
        width: 9
      }, "Relative time"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Input, {
        type: "text",
        className: "width-6",
        placeholder: "1h",
      ...
      }, "Time shift"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Input, {
        type: "text",
        className: "width-6",
        placeholder: "1h",
...
var VizTypePicker = function VizTypePicker(_ref) {
  ...
  }) : react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["EmptySearchResult"], null, "Could not find anything matching your query"));
};
...
function getPanelStateBadgeDisplayModel(panel) {
  switch (panel.state) {
    case _grafana_data__WEBPACK_IMPORTED_MODULE_1__["PluginState"].deprecated:
      return {
        ...
        color: 'red',
        tooltip: "".concat(panel.name, " panel is deprecated")
      };
  }
  ...
  return {
    ...
    icon: 'rocket',
    color: 'blue',
    tooltip: "".concat(panel.name, " panel is experimental")
  };
}
...
var PickerRenderer = function PickerRenderer(props) {
  ...
  if (!props.variable) {
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, "Couldn't load variable");
  }
...
//# sourceMappingURL=DashboardPage.aae40212254ed8359ce4.js.map