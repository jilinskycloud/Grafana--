...
function (_PureComponent) {
  ...
  _createClass(MetricTankMetaInspector, [{
    ...
    value: function renderMeta(meta, key) {
      ...
      var buckets = Object(_meta__WEBPACK_IMPORTED_MODULE_2__["parseSchemaRetentions"])(meta['schema-retentions']);
      var rollupNotice = Object(_meta__WEBPACK_IMPORTED_MODULE_2__["getRollupNotice"])([meta]);
      var runtimeNotice = Object(_meta__WEBPACK_IMPORTED_MODULE_2__["getRuntimeConsolidationNotice"])([meta]);
      ...
      try {
        for (var _iterator = buckets[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          totalSeconds += app_core_utils_kbn__WEBPACK_IMPORTED_MODULE_5__["default"].interval_to_seconds(bucket.retention);
        }
      } catch (err) {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
        ...
        var bucketLength = app_core_utils_kbn__WEBPACK_IMPORTED_MODULE_5__["default"].interval_to_seconds(bucket.retention);
      ...
      try {
        for (var _iterator2 = data[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          ...
          if (series.meta && series.meta.custom) {
            ...
            try {
              for (var _iterator3 = series.meta.custom.seriesMetaList[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                var metaItem = _step3.value;
...
function (_PureComponent) {
  ...
  function ConfigEditor(props) {
    ...
    _this.renderTypeHelp = function () {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, "There are different types of Graphite compatible backends. Here you can specify the type you are using. If you are using", ' ', react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
        href: "https://github.com/grafana/metrictank",
        className: "pointer",
        target: "_blank"
      }, "Metrictank"), ' ', "then select that here. This will enable Metrictank specific features like query processing meta data. Metrictank is a multi-tenant timeseries engine for Graphite and friends.");
    };
  ...
  _createClass(ConfigEditor, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_1__["DataSourceHttpSettings"], {
        ...
        className: "page-heading"
      }, "Graphite details"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      ...
      if (queries && queries.length > 0) {
        expandedQueries = queries.map(function (query) {
          var expandedQuery = _objectSpread({}, query, {
            ...
            target: _this2.templateSrv.replace(query.target, scopedVars)
          });
    ...
    value: function events(options) {
      try {
        ...
        return this.doGraphiteRequest({
          method: 'GET',
          url: '/events/get_data?from=' + this.translateTime(options.range.from, false, options.timezone) + '&until=' + this.translateTime(options.range.to, true, options.timezone) + tags
        });
      } catch (err) {
...
//# sourceMappingURL=graphitePlugin.aae40212254ed8359ce4.js.map