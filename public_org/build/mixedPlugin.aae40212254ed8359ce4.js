  ...
  _createClass(MixedDatasource, [{
    ...
    value: function query(request) {
      ...
      for (var _key in sets) {
        ...
        mixed.push({
          datasource: Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_5__["getDataSourceSrv"])().get(dsName),
          targets: targets
        });
      }
    ...
    value: function batchQueries(mixed, request) {
      ...
      return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["forkJoin"])(runningQueries).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(this.markAsDone), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mergeAll"])());
    }
  }, {
    key: "testDatasource",
    ...
    key: "markAsDone",
    value: function markAsDone(responses) {
...
//# sourceMappingURL=mixedPlugin.aae40212254ed8359ce4.js.map