...
var DashboardsTable = function DashboardsTable(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("table", {
    ...
    }, "Import") : react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
      className: "btn btn-secondary btn-small",
      onClick: function onClick() {
  ...
  _createClass(PluginDashboards, [{
    ...
    value: function render() {
      ...
      if (!dashboards || !dashboards.length) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, "No dashboards are included with this plugin");
      }
...
function (_PureComponent) {
  ...
  _createClass(PluginPage, [{
    ...
    value: function renderSidebarDependencies(dependencies) {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("section", {
        className: "page-sidebar-section"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h4", null, "Dependencies"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", {
        className: "ui-list plugin-info-list"
    ...
    value: function renderSidebarLinks(info) {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("section", {
        className: "page-sidebar-section"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h4", null, "Links"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", {
        className: "ui-list"
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(app_core_components_Page_Page__WEBPACK_IMPORTED_MODULE_7__["default"], {
        ...
        children: react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, "Check the server startup logs for more information. ", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("br", null), "If this plugin was loaded from git, make sure it was compiled.")
      }), this.renderBody()), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("aside", {
        className: "page-sidebar"
      }, plugin && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("section", {
        className: "page-sidebar-section"
...
function (_PureComponent) {
  ...
  _createClass(AppConfigCtrlWrapper, [{
    ...
    value: function render() {
      ...
      }, "Enable"), model.enabled && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Button"], {
        variant: "primary",
        onClick: this.update,
        className: withRightMargin
      }, "Update"), model.enabled && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Button"], {
        variant: "destructive",
...
//# sourceMappingURL=PluginPage.aae40212254ed8359ce4.js.map