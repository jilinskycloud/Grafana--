  ...
  _createClass(AzureLogAnalyticsDatasource, [{
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 6:
                ...
                _context2.next = 12;
                return this.buildDeepLink(df.meta);
      ...
      regeneratorRuntime.mark(function _callee3(meta) {
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                base64Enc = encodeURIComponent(meta.custom.encodedQuery);
                workspaceId = meta.custom.workspace;
                subscription = meta.custom.subscription;
                _context3.next = 5;
    ...
    value: function metricFindQuery(query) {
      ...
      return this.getDefaultOrFirstWorkspace().then(function (workspace) {
        var queries = _this2.buildQuery(query, null, workspace);

        var promises = _this2.doQueries(queries);
    ...
    value: function getDefaultOrFirstWorkspace() {
      ...
      return this.getWorkspaces(this.subscriptionId).then(function (workspaces) {
        _this3.defaultOrFirstWorkspace = workspaces[0].value;
        return _this3.defaultOrFirstWorkspace;
      });
    }
  }, {
    key: "annotationQuery",
    ...
    value: function doQueries(queries) {
      ...
      return lodash__WEBPACK_IMPORTED_MODULE_0___default.a.map(queries, function (query) {
        return _this4.doRequest(query.url).then(function (result) {
          return {
            result: result,
            query: query
          };
    ...
    value: function testDatasource() {
      ...
      return this.getDefaultOrFirstWorkspace().then(function (ws) {
        var url = "".concat(_this5.baseUrl, "/").concat(ws, "/metadata");
        ...
        message = _this5.getErrorMessage(message, error);
        return {
          status: 'error',
          message: message
        };
...
function (_DataSourceWithBacken) {
  ...
  _createClass(AzureMonitorDatasource, [{
    ...
    value: function filterQuery(item) {
      return item.hide !== true && item.azureMonitor.resourceGroup && item.azureMonitor.resourceGroup !== defaultDropdownValue && item.azureMonitor.resourceName && item.azureMonitor.resourceName !== defaultDropdownValue && item.azureMonitor.metricDefinition && item.azureMonitor.metricDefinition !== defaultDropdownValue && item.azureMonitor.metricName && item.azureMonitor.metricName !== defaultDropdownValue;
    }
  }, {
    key: "applyTemplateVariables",
    value: function applyTemplateVariables(target, scopedVars) {
      ...
      var dimensionsFilters = item.dimensionFilters.filter(function (f) {
        return f.dimension && f.dimension !== 'None';
      }).map(function (f) {
        var filter = templateSrv.replace(f.filter, scopedVars);
        return {
...
/* harmony import */ var _InsightsConfig__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./InsightsConfig */ "./public/app/plugins/datasource/grafana-azure-monitor-datasource/components/InsightsConfig.tsx");
/* harmony import */ var _azure_monitor_response_parser__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../azure_monitor/response_parser */ "./public/app/plugins/datasource/grafana-azure-monitor-datasource/azure_monitor/response_parser.ts");
/* harmony import */ var app_core_utils_CancelablePromise__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! app/core/utils/CancelablePromise */ "./public/app/core/utils/CancelablePromise.ts");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_PureComponent) {
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_5__["getBackendSrv"])().put("/api/datasources/".concat(_this.props.options.id), _this.props.options).then(function (result) {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 3;
                return Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_5__["getBackendSrv"])().datasourceRequest({
              ...
              case 3:
                ...
                return _context3.abrupt("return", _azure_monitor_response_parser__WEBPACK_IMPORTED_MODULE_7__["default"].parseSubscriptionsForSelect(result));
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 6:
                ...
                return _context4.abrupt("return", _azure_monitor_response_parser__WEBPACK_IMPORTED_MODULE_7__["default"].parseWorkspacesForSelect(result));
      ...
      return regeneratorRuntime.wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              sameAs = _this.props.options.jsonData.azureLogAnalyticsSameAs && _this.props.options.jsonData.subscriptionId;

              if (!(!sameAs && !_this.props.options.jsonData.logAnalyticsSubscriptionId)) {
                _context7.next = 3;
                break;
              }
            ...
            case 3:
              _context7.next = 5;
              return _this.loadWorkspaces(sameAs ? _this.props.options.jsonData.subscriptionId : _this.props.options.jsonData.logAnalyticsSubscriptionId);
  ...
  _createClass(ConfigEditor, [{
    ...
    value: function componentDidMount() {
      this.initPromise = Object(app_core_utils_CancelablePromise__WEBPACK_IMPORTED_MODULE_8__["makePromiseCancelable"])(this.init());
    ...
    value: function render() {
      ...
      }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_InsightsConfig__WEBPACK_IMPORTED_MODULE_6__["InsightsConfig"], {
        options: options,
...
function (_React$Component2) {
  ...
  function QueryField(props, context) {
    ...
    _this2.request = function (url) {
      if (_this2.props.request) {
        return _this2.props.request(url);
      }
    ...
    _this2.updateMenu = function () {
      ...
      var selection = window.getSelection();
      var node = selection.anchorNode; // No menu, nothing to do
...
function (_QueryCtrl) {
  ...
  function AzureMonitorQueryCtrl($scope, $injector, templateSrv) {
    ...
    _this.panelCtrl.events.on(_grafana_data__WEBPACK_IMPORTED_MODULE_5__["PanelEvents"].dataReceived, _this.onDataReceived.bind(_assertThisInitialized(_this)), $scope);

    _this.panelCtrl.events.on(_grafana_data__WEBPACK_IMPORTED_MODULE_5__["PanelEvents"].dataError, _this.onDataError.bind(_assertThisInitialized(_this)), $scope);
  ...
  _createClass(AzureMonitorQueryCtrl, [{
    ...
    value: function convertTimeGrainsToMs(timeGrains) {
      ...
      timeGrains.forEach(function (tg) {
        if (tg.value !== 'auto') {
          allowedTimeGrainsMs.push(app_core_utils_kbn__WEBPACK_IMPORTED_MODULE_4__["default"].interval_to_ms(_time_grain_converter__WEBPACK_IMPORTED_MODULE_2__["default"].createKbnUnitFromISO8601Duration(tg.value)));
        }
      });
    ...
    value: function generateAutoUnits(timeGrain, timeGrains) {
      if (timeGrain === 'auto') {
        return _time_grain_converter__WEBPACK_IMPORTED_MODULE_2__["default"].findClosestTimeGrain(this.templateSrv.getBuiltInIntervalValue(), lodash__WEBPACK_IMPORTED_MODULE_0___default.a.map(timeGrains, function (o) {
    ...
    key: "getAppInsightsAutoInterval",

    /* Application Insights Section */
    value: function getAppInsightsAutoInterval() {
...
//# sourceMappingURL=azureMonitorPlugin.aae40212254ed8359ce4.js.map