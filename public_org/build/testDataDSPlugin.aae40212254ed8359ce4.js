...
function (_PureComponent) {
  ...
  _createClass(TestInfoTab, [{
    key: "render",
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, "See github for more information about setting up a reproducable test environment.", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("br", null), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("br", null), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
...
/* harmony import */ var app_features_variables_utils__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! app/features/variables/utils */ "./public/app/features/variables/utils.ts");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
  ...
  _createClass(TestDataDataSource, [{
        ...
        for (var _iterator = options.targets[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          if (target.scenarioId === 'streaming_client') {
            ...
            queries.push(_objectSpread({}, target, {
              ...
              alias: app_features_templating_template_srv__WEBPACK_IMPORTED_MODULE_6__["default"].replace(target.alias || '')
            }));
          }
        }
      } catch (err) {
    ...
    value: function metricFindQuery(query, options) {
      return new Promise(function (resolve, reject) {
        setTimeout(function () {
          var interpolatedQuery = app_features_templating_template_srv__WEBPACK_IMPORTED_MODULE_6__["default"].replace(query, Object(app_features_variables_utils__WEBPACK_IMPORTED_MODULE_7__["getSearchFilterScopedVar"])({
            query: query,
            wildcardChar: '*',
            options: options
          }));
...
//# sourceMappingURL=testDataDSPlugin.aae40212254ed8359ce4.js.map