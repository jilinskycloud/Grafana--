...
const helpOptions = [
  { value: 0, label: '文献资料', href: 'https://grafana.com/docs/grafana/latest' },
  { value: 1, label: '讲解', href: 'https://grafana.com/tutorials' },
  { value: 2, label: '社区', href: 'https://community.grafana.com' },
  { value: 3, label: '公共松弛', href: 'http://slack.grafana.com' },
];
...
export const WelcomeBanner: FC = () => {
  ...
  return (
    <div className={styles.container}>
      <h1 className={styles.title}>欢迎来到-哥让发呢</h1>
