...
const tooltipText = 'api密钥生存期。例如1d，如果您的钥匙要使用一天。所有支持的单元包括： s,m,h,d,w,M,y';
      ...
      <>
        {!isAdding && (
          <EmptyListCTA
            ...
            buttonTitle=" 新建API密钥"
            proTip="请记住，您可以为其他应用程序提供仅查看的API访问。"
          />
        )}
        ...
        <div className="cta-form">
          ...
          <form className="gf-form-group" onSubmit={this.onAddApiKey}>
            <div className="gf-form-inline">
              ...
              <div className="gf-form max-width-21">
                <InlineFormLabel tooltip={tooltipText}>生存的时间</InlineFormLabel>
                <Input
                  type="text"
                  className="gf-form-input"
                  placeholder="1d"
